    ...
    $(document).ready(function(){
        ...
        $('input:radio[name="flow"]').change(function(){
            if($(this).val() =='<?php echo WALL_POST_COMMENT_FLOW_FIFO;?>'){
                commentPostFlowType('<?php echo WALL_POST_COMMENT_FLOW_FIFO;?>','c');
            }else{
                commentPostFlowType('<?php echo WALL_POST_COMMENT_FLOW_LIFO;?>','c');
            }
        });
        $('input:radio[name="type"]').change(function(){
            ...
            commentAssignTypeChange(currentVal,'c');
        }); 
    });
