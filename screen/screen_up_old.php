        ...
        <head>
            ...
            <script type="">
                ...
                $(document).ready(function(){
                    screenReload()
                    //setInterval(function(){screenReload();},1000);
                });
            ...
            <div class="container-fluid">
                ...
                <div class="row gp">
                    <table border="2" bordercolor="#86C653" style="display: none;">
                        <tbody id="groupStatusHtml">
                            ...
                            <tr>
                                <td class="gp_name">Idol Agents</td>
                    ...
                    <div class="col-md-4">
                        <table border="2" bordercolor="#86C653" id="groupStatus">

                            <!--<tr>
                            <td rowspan="4" class="gp_title">GP</td>
                            <td class="gp_name">Available Agents</td>
                            <td class="gp_num">10</td>
                            </tr>
                            <tr>
                            <td class="gp_name">Service Agents</td>
                            <td class="gp_num">6</td>
                            </tr>
                            <tr>
                            <td class="gp_name">Idol Agents</td>
                            <td class="gp_num">2</td>
                            </tr>
                            <tr>
                            <td class="gp_name">Break Agents</td>
                            <td class="gp_num">2</td>
                            ...
                            <tr>
                            <td rowspan="4" class="ssl_title">SSL</td>
                            <td class="ssl_name">Available Agents</td>
                            <td class="gp_num">13</td>
                            </tr>
                            <tr>
                            <td class="ssl_name">Service Agents</td>
                            <td class="gp_num">10</td>
                            </tr>
                            <tr>
                            <td class="ssl_name">Idol Agents</td>
                            <td class="gp_num">1</td>
                            </tr>
                            <tr>
                            <td class="ssl_name">Break Agents</td>
                            <td class="gp_num">2</td>
                            </tr>-->
                        </table>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="LIFO_FIFO">
                            ...
                            <table border="1" width="100%">
                                ...
                                <tr>
                                    <td class="fifo_name">Ramesh Raman</td>
                                    <td class="lifo_num">5000</td>
                                    <td class="fifo_num">5000</td>
                                </tr>
                                <tr>
                                    <td class="fifo_name">Shabbir Hussein</td>
                                    <td class="lifo_num">7000</td>
                                    <td class="fifo_num">7000</td>
                                </tr>
                            </table>
                ...
                <div class="row comments">
                    <div class="col-md-6">
                        <table border="1" bordercolor="#00A8E7">
                            <tr>
                                <td rowspan="6" class="title">Top 5 Present comments reply duration:</td>
                                <td class="comments1" width="10%">SL</td>
                                <td class="comments2" width="30%">Name</td>
                                <td class="comments3" width="20%">Time</td>
                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="name">Md. Rakib Hossain</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">2</td>
                                <td class="name">Irfan Ahmad</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">3</td>
                                <td class="name">Ummul Khair</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">4</td>
                                <td class="name">Md. Saydur Rahman</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">5</td>
                                <td class="name">Zia Uddin Gazi</td>
                                <td class="time">0:05:29</td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="row comments">
                    <div class="col-md-6">
                        <table border="1" bordercolor="#00A8E7">
                            <tr>
                                <td rowspan="4" class="title">Maximum AHT live:</td>

                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="max_name">Md. Ashiqur Rahman</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">2</td>
                                <td class="max_name">A.K.M Shafiqul Alam</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">3</td>
                                <td class="max_name">Sheikh Mobassher Enam</td>
                                <td class="time">0:05:29</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table border="1" bordercolor="#00A8E7">
                            <tr>
                                <td rowspan="4" class="title" >Minimum AHT live:</td>

                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="min_name">Irfan Ahmad</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="min_name">Ummul Khair</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="min_name">Md. Saydur Rahman</td>
                                <td class="time">0:05:29</td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="row comments">
                    <div class="col-md-6">
                        <table border="1" bordercolor="#00A8E7">
                            <tr>
                                <td rowspan="4" class="title" >Maximum ART live:</td>

                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="max_name">Irfan Ahmad</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">2</td>
                                <td class="max_name">Ummul Khair</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">3</td>
                                <td class="max_name">Md. Saydur Rahman</td>
                                <td class="time">0:05:29</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table border="1" bordercolor="#00A8E7">
                            <tr>
                                <td rowspan="4" class="title">Minimum ART live:</td>

                            </tr>
                            <tr>
                                <td class="SL">1</td>
                                <td class="min_name">Md. Ashiqur Rahman</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">2</td>
                                <td class="min_name">A.K.M Shafiqul Alam</td>
                                <td class="time">0:05:29</td>
                            </tr>
                            <tr>
                                <td class="SL">3</td>
                                <td class="min_name">Sheikh Mobassher Enam</td>
                                <td class="time">0:05:29</td>
                            </tr>
                        </table>
                    </div>
