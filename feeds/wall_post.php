...
<div class="col-md-6">
    <div class="x_panel wall_post">
        <div class="x_title">
            <h2 id="wallPostTitle">Wall Post</h2>
        ...
        <div class="x_content">
            <div class="post">
                <div class="post-content" id="posthilight">
                    <div class="post_header clearfix">
                        <div class="post_header_pp">
                            <a href="javascript:void();" title="">
                                <img id="visitor_main_propic" class="post_profile_picture" src="images/man_icon2.png">
                            </a>
                        </div>
                        <div class="post_header_name">
                            <div class="name">
                                <div class="name_2" id="visitor_main_name"></div>
                                <ul class="provider_icons">
                                    <li class="original_post_time_from_now"><i id="post_time"></i></li>
                                </ul>
                            </div>
                        </div>                
                    </div>
                    <div class="post_story clearfix">
                        ...
                        <div class="provider_status_text" style="float: left;width:49%;height:270px;" id="commentFromFb"></div>
                    </div>
                </div>
                <a class="show_full_post" href="javascript:void(0); "></a>
            ...
            <div class="check_service_area" style="display:block;border:none;box-shadow:none;float:left;">
                <div class="check_service" style="margin-left:0;">
                    ...
                    <div style="display: none;">
                        ...
                        <label for="include0"> N</label>
                        <input id="include1" type="radio" name="wallPostInclude" value="1" data-value="" <?php echo $general->checked(1,$check);?>>
                        <label for="include1"> C.</label>
                        <input id="include2" type="radio" name="wallPostInclude" value="2" data-value="<?php echo $userData['uFullName'];?>" <?php echo $general->checked(2,$check);?>>
                        <label for="include2" title="I"> M</label>
                ...
                <div class="close_service">
                    ...
                    <?php
                        if($canDelete==true){
                        ?>
                        <a href="javascript:void();" onclick="removePostComment()"><i class="fa fa-check" aria-hidden="true"></i>Delete</a>

                    <?php
                        }
                        if($canBan==true){
                        ?>
                        <a href="javascript:void();" onclick="banUser()"><i class="fa fa-check" aria-hidden="true"></i>Ban</a>
                        <?php
                        }
                    ?>
            ...
            <div class="close_service" id="wallPostCloseCall">
                ...
                <label for="wallPostClose">S &amp; C</label>
            </div>
...
<div style="display: none;">
        ...
        <ul class="check_service modal_checkbox" style="height: 300px;overflow-y: auto;overflow-x:hidden;">
            ...
            <li>
                <div class="input-group modal_number">
                    ...
                    <label class="wrapUpNumberLabel"><input type="text" class="wrapUpNumber form-control" onkeypress="return commentReplyWrapupType(event)"></label>
                </div>
            </li>
            <li>
    ...
    <div id="Scentiment_list">
        <ul class="check_service modal_checkbox">
            ...
            <li>
                ...
                <label for="positive">&nbsp;&nbsp;<span><?php echo SCENTIMENT_TYPE_POSITIVE ?>. </span><?php echo $general->getScentimentName(SCENTIMENT_TYPE_POSITIVE);?> </label>
            </li>
            <li>
                <input id="nutral" type="radio" name="ScentimentType" value="<?php echo SCENTIMENT_TYPE_NUTRAL ?>">
                <label for="nutral">&nbsp;&nbsp;<span><?php echo SCENTIMENT_TYPE_NUTRAL ?>. </span><?php echo SCENTIMENT_TYPE_NUTRAL;?> </label>
            </li>
            <li>
                <input id="negetive" type="radio" name="ScentimentType" value="<?php echo SCENTIMENT_TYPE_NEGETIVE ?>">
                <label for="negetive">&nbsp;&nbsp;<span><?php echo SCENTIMENT_TYPE_NEGETIVE ?>. </span><?php echo $general->getScentimentName(SCENTIMENT_TYPE_NEGETIVE);?> </label>
            </li>
            <li>
                <div class="input-group modal_number">
                    <span class="input-group-btn">
    ...
    <div id="whole_thread">
        <div class="post-content">
            <div class="post_story clearfix">
                <div class="provider_status_text">
                    <img src="" alt="" style="" id="whole_status_image">
                    <div id="whole_status_text"></div>
                </div>
            </div>
        </div>
        ...
        <div class="comment_container">                      
            <div class="comment" id="whole_main_comment"></div>                                          
        </div>
    </div>
            ...
            <div class="comment_body">
                ...
                <div class="comment_social clearfix">
                    <div class="comment_actions">
                        <div class="action with_bull comment_time_from_now"> <a class="time" target="_blank"></a> </div>
                    </div>
                </div>
            </div>
        </div>
