        ...
        if(rpUsers.length>index){
            ...
            $.post(ajUrl,{loadTrafficAnalysisReport:1,from:rpUsers[index].from,to:rpUsers[index].to},function(data){
                if(data.status==1){
                    ...
                    var exportI={
                        d:reportDate,f:c.from,t:c.to,rc:c.qReceived,rp:c.totalReply,r2:c.totalReply20Min,h:c.aht,r:c.art,m:c.mwt,rr:c.rr,sl:c.sl}
                    ...
                    var exportI={
                        d:reportDate,f:w.from,t:w.to,rc:w.qReceived,rp:w.totalReply,r2:w.totalReply20Min,h:w.aht,r:w.art,m:w.mwt,rr:w.rr,sl:w.sl}
